...
const FilterModal: React.FC<FilterModalProps> = ({ isOpen, onClose }) => {
  ...
  useEffect(() => {
    if (isOpen) {
      ...
      // Expand section with active filters
      setExpandedSections({
  ...
  return (
    <div className="fixed inset-0 z-50 flex">
      ...
      {/* Sidebar */}
      <div className={`fixed right-0 top-0 h-full w-full max-w-md bg-white shadow-2xl transform transition-transform duration-300 ${
        ...
        <div className="h-full flex flex-col">
          ...
          <div className="border-t border-gray-200 p-6 space-y-3">
            <button
              ...
              className="w-full bg-[#7CAD39] hover:bg-[#6B9A32] text-white font-semibold py-4 rounded-xl transition-colors text-base"
            >
              Aplicar filtros
            </button>
            <button
              ...
              className="w-full bg-white hover:bg-gray-50 text-gray-700 font-medium py-3 rounded-xl border border-gray-300 transition-colors text-base"
            >
              Limpiar filtros
            </button>
          </div>
